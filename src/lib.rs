...
pub type rtlsdr_read_async_cb_t = extern "C" fn(buf: *mut c_uchar, len: u32, ctx: *mut c_void);
...
extern "C" {
    ...
    pub fn rtlsdr_write_eeprom(dev: rtlsdr_dev_t, data: *const u8, offset: u8, len: u16) -> c_int;
